...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-zinc-50 dark:bg-black text-zinc-900 dark:text-white py-12 border-t border-zinc-200 dark:border-zinc-800 transition-colors duration-500">
      <div className="container mx-auto px-4 md:px-6 text-center">
        ...
        <div className="flex justify-center items-center mb-4">
          <img 
            ...
            alt="VGot You Logo"
            className="h-10 w-10 mr-3 invert dark:invert-0 transition-all duration-500"
          />

          <h3 className="text-3xl font-bold font-cambria text-zinc-900 dark:text-white">VGot You</h3>
        </div>

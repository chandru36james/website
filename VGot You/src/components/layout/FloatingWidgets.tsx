...
const FloatingWidgets: React.FC = () => {
    ...
    useEffect(() => {
        ...
        window.addEventListener('mobile-menu-change', handleMenuChange);
        return () => window.removeEventListener('mobile-menu-change', handleMenuChange);
    }, []);
    ...
    return (
        <motion.div 
            ...
            className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-[100] flex flex-col items-end gap-3 pointer-events-none"
        >

...
const WebDesignTN: React.FC = () => {
  ...
  `}</script>
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen w-full -mt-20 flex items-center overflow-hidden">
        <div className="absolute inset-0 grid-bg opacity-40"></div>
        <div className="absolute inset-0 bg-gradient-to-t from-[#020202ce] via-transparent to-transparent"></div>
        
        <div className="absolute right-0 top-0 w-full h-full opacity-20 pointer-events-none">
          <img src="/assets/tamil-nadu-hero.jpg" alt="Digital web design services for Tamil Nadu businesses – VGot You" className="w-full h-full object-cover grayscale-[40%]" />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-[9vw] sm:text-[7vw] md:text-[5.5vw] font-black mb-7 tracking-tighter uppercase leading-[0.85]">
                Powering <br/>
                <span className="text-white/20">Tamil Nadu's Digital Era.</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-6">
                <Link
                  to="/contact?message=Hi VGot You, I'm interested in web design services for my business in Tamil Nadu."

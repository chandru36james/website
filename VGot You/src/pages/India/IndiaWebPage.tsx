      ...
      <section className="py-16 md:py-24 px-6 border-b border-zinc-900 bg-black relative">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-12 md:mb-16">
            ...
            <h2 className="text-3xl md:text-6xl font-black uppercase tracking-tighter mt-4 text-zinc-800">Major Digital Hubs</h2>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {[
              ...
              <Link 
                key={i}
                to={city.link}
                className="group p-6 border border-zinc-900 bg-zinc-950/30 rounded-sm hover:border-red-600/50 transition-all text-center"
              >
                <span className="text-technical text-[10px] md:text-xs uppercase tracking-[0.3em] text-zinc-500 group-hover:text-white transition-colors">{city.name}</span>
                <div className="mt-4 h-[1px] w-0 group-hover:w-full bg-red-600 mx-auto transition-all duration-500"></div>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 md:py-48 px-6 text-center bg-black relative overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 md:gap-10">
            <Link to="/contact?message=Hi VGot You, I'm interested in starting a project for my business in India." className="relative w-full sm:w-auto px-12 md:px-16 py-5 md:py-6 bg-red-600 text-white font-bold rounded-sm text-xs md:text-sm uppercase tracking-[0.3em] md:tracking-[0.4em] shadow-[0_0_50px_rgba(220,38,38,0.3)] hover:scale-105 transition-all">
              Initiate India Node
            </Link>

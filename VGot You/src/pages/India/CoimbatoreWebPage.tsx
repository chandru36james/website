...
const CoimbatoreWebPage: React.FC = () => {
  const industries = [
    {
      ...
      desc: "B2B and export-focused websites for Coimbatore's world-famous spinning mills, weavers and textile manufacturers."
    },
    {
      title: "Engineering & Manufacturing",
      desc: "Professional B2B websites for Coimbatore's precision engineering, pump manufacturing and industrial component firms."
    },
    {
      title: "Education & Healthcare",
      desc: "Trust-building websites for Coimbatore's leading educational institutions, hospitals and healthcare providers."
    },
    {
      title: "Retail & E-commerce",
      desc: "High-converting online stores for Coimbatore retailers and D2C brands targeting Tamil Nadu and India."
    }
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Our Coimbatore web design packages start from ₹4,999. We provide transparent, fixed-price quotes with no hidden fees."
    },
    {
  ...
  return (
    <div className="bg-[#020202] text-white selection:bg-red-600/30 overflow-x-hidden pt-16 md:pt-20">
      <Helmet>
        ...
        <meta name="description" content="VGot You is a professional web design company serving Coimbatore businesses — textile manufacturers, engineering firms and startups. Fast, SEO-optimised websites from ₹4,999." />
        ...
        <meta property="og:description" content="VGot You is a professional web design company serving Coimbatore businesses — textile manufacturers, engineering firms and startups. Fast, SEO-optimised websites from ₹4,999." />
        ...
        <meta name="twitter:description" content="VGot You is a professional web design company serving Coimbatore businesses — textile manufacturers, engineering firms and startups. Fast, SEO-optimised websites from ₹4,999." />
      ...
      <section className="relative py-20 md:py-32 border-b border-zinc-900">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl">
            <TechnicalBadge className="mb-6">Location: Coimbatore, TN</TechnicalBadge>
            <h1 className="text-5xl md:text-8xl font-black tracking-tighter leading-[0.9] mb-8">
              WEB DESIGN <br />
              <span className="text-red-600">COIMBATORE.</span>
            </h1>
            <h2 className="sr-only">Web Design Company in Coimbatore, Tamil Nadu – Affordable Websites for Textile, Manufacturing & Business | VGot You</h2>
            <p className="text-zinc-400 text-lg md:text-xl font-light leading-relaxed max-w-2xl">
              Coimbatore — the Manchester of South India — is one of Tamil Nadu's most important industrial cities. Known globally for its textile industry, engineering excellence and a fast-growing startup ecosystem, Coimbatore businesses need websites that reflect their industrial strength and global ambitions. VGot You builds high-performance, SEO-optimised websites for Coimbatore businesses — from Peelamedu textile exporters to RS Puram service providers.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-32 border-b border-zinc-900">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              <h2 className="text-3xl md:text-5xl font-black tracking-tighter mb-8 uppercase">Web Design for <br /><span className="text-red-600">Coimbatore Businesses</span></h2>
              <div className="space-y-6 text-zinc-400 text-sm md:text-base leading-relaxed">
                ...
                <div className="p-6 border border-red-600/20 bg-red-600/5 rounded-sm">
                  ...
                  <p className="text-white text-sm">Your nearest Tamil Nadu web design partner. Based in Karur, serving Coimbatore with local expertise.</p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-black tracking-tighter uppercase">Coimbatore <span className="text-red-600">FAQ</span></h2>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="bg-red-600 p-12 md:p-24 text-center relative overflow-hidden group">
            <div className="relative z-10">
              <h2 className="text-4xl md:text-7xl font-black tracking-tighter mb-8 uppercase">Join Coimbatore Businesses <br />Growing with VGot You</h2>
              ...
              <Link 
                to="/contact?message=Hi VGot You, I'm interested in a web design quote for my Coimbatore-based business." 

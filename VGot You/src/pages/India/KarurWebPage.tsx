...
const TechnicalBadge = ({ children, className }: { children?: React.ReactNode, className?: string }) => (
  <span className={`inline-block px-3 py-1 border border-zinc-200 rounded-sm bg-zinc-100 text-[8px] md:text-[9px] font-mono tracking-[0.3em] uppercase text-zinc-600 ${className}`}>
    {children}
  </span>
);
    ...
    <div className="border-b border-zinc-200 group">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <p className="pb-5 md:pb-6 text-zinc-600 text-xs md:text-sm leading-relaxed max-w-3xl">
              {answer}
            </p>
          </m.div>
        )}
...
const WebDesignKarur: React.FC = () => {
  ...
  return (
    <div className="bg-white text-zinc-900 selection:bg-red-600/10 overflow-x-hidden pt-16 md:pt-20">
      <Helmet>
  ...
  `}</script>
      ...
      {/* Hero Section */}
      <section className="relative min-h-[80vh] md:min-h-[80vh] flex items-center justify-center border-b border-zinc-200 bg-grid overflow-hidden px-6">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-20">
          <div className="w-full h-1 bg-red-600/30 shadow-[0_0_15px_rgba(220,38,38,0.3)] animate-scan"></div>
        </div>
  ...
  <span className="text-zinc-500">in Karur, Tamil Nadu</span>
</h1>
              
              <p className="text-base md:text-xl text-zinc-600 font-light leading-relaxed mb-10 md:mb-12 max-w-xl">
                VGot You is a top-rated affordable <Link to="/web-design" className="text-zinc-700 hover:text-red-600 transition-colors">online web design agency for Karur</Link>, specializing in digital platforms for the city's global textile export backbone.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-6 md:gap-8">
                <Link to="/contact?message=Hi VGot You, I'm interested in a web design quote for my Karur-based business." className="w-full sm:w-auto group relative px-10 md:px-12 py-4 md:py-5 bg-red-600 text-white font-bold rounded-sm text-[10px] md:text-xs uppercase tracking-[0.4em] overflow-hidden transition-all shadow-[0_0_40px_rgba(220,38,38,0.2)] hover:shadow-red-600/40 text-center">
                  ...
                  <span className="absolute inset-0 z-10 flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">Get Free Website Quote</span>
                </Link>
            ...
            <div className="relative hidden lg:block">
              <m.div 
                ...
                className="relative aspect-square border border-zinc-200 bg-white/50 rounded-sm p-8 group"
              >
                <HUDMarker />
                ...
                <div className="relative w-full h-full overflow-hidden border border-zinc-200 rounded-sm  transition-all duration-1000">
                  <img 
                    src="/assets/karur.jpg" 
                    alt="Karur textile industry – web design services for exporters by VGot You" 
                    className="w-full h-full object-cover saturate-130 contrast-110 brightness-105 transition-all duration-700 group-hover:scale-110" 
                    loading="lazy"
                  />
                  ...
                  <div className="absolute inset-0 p-8 flex flex-col justify-between pointer-events-none">
                    <div className="flex justify-between items-start">
                      ...
                      <span className="text-technical text-[8px] text-zinc-500 uppercase">Region: Karur_Industrial_Core</span>
                    </div>
                    
                    <div className="bg-white/80 backdrop-blur-md border border-zinc-200 p-4 transform translate-y-4 group-hover:translate-y-0 transition-transform">
                      <div className="flex justify-between text-[8px] font-mono text-zinc-600 mb-2 uppercase tracking-widest">
      ...
      <section className="py-16 md:py-24 px-6 border-b border-zinc-200 bg-white">
        <div className="container mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-6">Web Design Services in Karur</h2>
            <p className="text-zinc-600 text-base md:text-lg leading-relaxed">
              We build professional websites for Karur businesses including textile exporters, shops, and service providers. Our websites are designed to generate enquiries, improve trust, and help you rank on Google.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* SEO Section */}
      <section className="py-16 md:py-24 px-6 border-b border-zinc-100 bg-white">
        <div className="container mx-auto max-w-7xl">
          <div className="grid lg:grid-cols-3 gap-10 md:gap-16">
            <div className="lg:col-span-1">
              ...
              <p className="text-zinc-600 text-xs md:text-sm leading-relaxed mb-6 md:mb-8">
                As a leading <strong className="text-zinc-700 font-bold">SEO service for Karur businesses</strong>, we build marketing engines that rank for terms that drive B2B growth, helping textile exporters reach new global markets through specialized online search visibility.
              </p>
              <Link to="/web-design-tamil-nadu" className="text-technical text-[8px] md:text-[9px] font-bold text-red-600 hover:text-zinc-900 transition-colors uppercase tracking-[0.3em] inline-flex items-center gap-3">
                Tamil_Nadu_Network
            ...
            <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
              {[
                ...
                <div key={i} className="p-6 md:p-8 border border-zinc-200 bg-white rounded-sm group hover:border-red-600/30 transition-all">
                  <span className="text-technical text-[7px] md:text-[8px] text-zinc-500 group-hover:text-red-600 transition-colors block mb-3 md:mb-4">[{item.code}]</span>
                  <h3 className="text-base md:text-lg font-bold uppercase mb-2 md:mb-3 text-zinc-900">{item.t}</h3>
                  <p className="text-zinc-600 text-[10px] md:text-xs leading-relaxed">{item.d}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            {sectors.map((sector, i) => (
              <m.div 
                key={i}
                whileHover={{ y: -5 }}
                className="relative p-5 md:p-6 border border-zinc-200 bg-white flex flex-col items-center text-center group overflow-hidden"
              >
                <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-red-600/20 to-transparent"></div>
                <span className="text-technical text-[7px] md:text-[8px] text-zinc-500 mb-2">{sector.code}</span>
                <h4 className="text-sm md:text-lg font-bold uppercase tracking-tight text-zinc-700 group-hover:text-zinc-900 transition-colors">{sector.name}</h4>
                <div className="mt-3 md:mt-4 text-technical text-[9px] md:text-xs font-bold text-black group-hover:text-red-600 transition-colors duration-300">
                   REMOTE_READY
                </div>
              </m.div>
            ))}
      ...
      {/* Portfolio Showcase */}
      <section className="py-16 md:py-24 px-6 border-b border-zinc-200 bg-white overflow-hidden">
        <div className="container mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row items-center gap-12 md:gap-24">
            <div className="flex-1 order-2 lg:order-1">
              <div className="relative aspect-[16/10] rounded-sm overflow-hidden border border-zinc-200 shadow-2xl group">
                <img 
                ...
                <div className="absolute bottom-4 md:bottom-6 left-4 md:left-6 flex flex-col">
                  ...
                  <span className="text-technical text-[9px] md:text-[10px] uppercase font-bold text-zinc-900 tracking-widest">Global_Export_Node</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 order-1 lg:order-2">
              ...
              <p className="text-zinc-600 text-sm md:text-lg leading-relaxed mb-8 md:mb-10">
              ...
              <div className="grid grid-cols-2 gap-6 md:gap-8 border-t border-zinc-200 pt-8 md:pt-10">
                <div>
                  <span className="text-technical text-[7px] md:text-[8px] text-zinc-500 uppercase block mb-1">Service_Satisfaction</span>
                  <span className="text-2xl md:text-3xl font-black text-zinc-900">100%</span>
                </div>
                <div>
                  <span className="text-technical text-[7px] md:text-[8px] text-zinc-500 uppercase block mb-1">Global_Node_Uptime</span>
                  <span className="text-2xl md:text-3xl font-black text-zinc-900">99.9%</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 px-6 border-b border-zinc-200 bg-white overflow-hidden relative">
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="mb-12 md:mb-20">
            ...
            <p className="text-zinc-600 mt-3 md:mt-4 text-xs md:text-base max-w-2xl italic">Deep dives into how we scale Karur's local icons into global digital authorities.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            {[
              ...
              <div key={i} className="p-6 md:p-8 border border-zinc-200 bg-white hover:border-red-600/50 transition-all group rounded-sm flex flex-col justify-between min-h-[220px] md:min-h-[250px]">
                <div>
                  <h3 className="text-xl md:text-2xl font-bold uppercase text-zinc-900 mb-3 md:mb-4 group-hover:text-red-500 transition-colors leading-tight">{caseStudy.title}</h3>
                  <p className="text-zinc-600 text-[10px] md:text-xs leading-relaxed mb-6 md:mb-8">{caseStudy.desc}</p>
                </div>
                <Link to={caseStudy.link} className="inline-flex items-center gap-3 md:gap-4 text-technical text-[8px] md:text-[9px] font-bold text-zinc-900 uppercase tracking-[0.3em] hover:text-red-600 transition-all">
                  {caseStudy.label}
                  <div className="w-6 md:w-8 h-[1px] bg-zinc-200 group-hover:w-12 group-hover:bg-red-600 transition-all"></div>
                </Link>
              </div>
            ))}
          </div>
      ...
      {/* Services Register */}
      <section className="py-16 md:py-24 px-6 relative bg-white border-b border-zinc-200">
        <div className="container mx-auto max-w-7xl">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 md:mb-20 gap-6 md:gap-8">
            <div className="max-w-2xl">
              ...
              <h2 className="text-3xl md:text-7xl font-black uppercase tracking-tighter mt-4">Online <span className="text-zinc-500">Capabilities</span></h2>
            </div>
            <p className="text-zinc-500 text-technical text-[8px] md:text-[9px] uppercase tracking-widest leading-loose text-right hidden lg:block border-l border-zinc-200 pl-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1">
            {[
              ...
              <div key={i} className="p-8 md:p-10 border border-zinc-200 bg-white hover:bg-zinc-100 transition-colors group">
                ...
                <h3 className="text-lg md:text-xl font-bold uppercase mb-3 md:mb-4 text-zinc-900 group-hover:text-red-500 transition-colors">{s.t}</h3>
                <p className="text-zinc-500 text-xs md:text-sm leading-relaxed group-hover:text-zinc-700 transition-colors">{s.d}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 md:py-20 px-6 border-b border-zinc-200 bg-white">
        <div className="container mx-auto max-w-7xl">
           <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-12 border border-zinc-200 p-8 md:p-12 rounded-sm relative overflow-hidden text-center md:text-left bg-white">
              <div className="absolute top-0 right-0 p-8 opacity-5 hidden sm:block">
                <svg width="200" height="200" viewBox="0 0 100 100"><circle cx="50" cy="50" r="48" stroke="black" strokeWidth="0.1" fill="none" /></svg>
              </div>
              <div className="relative z-10">
                 <h2 className="text-2xl md:text-3xl font-black uppercase tracking-tighter mb-2">Regional Expansion</h2>
                 <p className="text-zinc-600 text-[10px] md:text-sm uppercase tracking-widest font-mono">Scaling digital growth across the entire Southern network.</p>
                 <div className="flex flex-wrap gap-4 mt-4">
                    <Link to="/web-design-chennai" className="text-technical text-[8px] text-zinc-500 hover:text-red-600 transition-colors uppercase tracking-widest">Also serving Chennai &rarr;</Link>
                    <Link to="/web-design-coimbatore" className="text-technical text-[8px] text-zinc-500 hover:text-red-600 transition-colors uppercase tracking-widest">Also serving Coimbatore &rarr;</Link>
                 </div>
              </div>
              <Link to="/web-design-tamil-nadu" className="relative z-10 group flex items-center gap-4 md:gap-6 text-technical text-[10px] md:text-xs font-bold uppercase tracking-[0.4em] text-red-600 hover:text-zinc-900 transition-all">
                Access Tamil Nadu Hub
                <div className="w-10 md:w-16 h-[1px] bg-red-600 group-hover:w-24 group-hover:bg-zinc-900 transition-all"></div>
              </Link>
           </div>
        </div>
      </section>
      ...
      {/* Final CTA */}
      <section className="py-24 md:py-48 px-6 text-center bg-white relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(220,38,38,0.05)_0%,transparent_70%)] opacity-50"></div>
        <m.div
          initial={{ opacity: 0 }}
        ...
        >
          ...
          <h2 className="text-[12vw] sm:text-[10vw] md:text-[8.5vw] font-black uppercase leading-[0.8] mb-12 md:mb-16 tracking-tighter">
            Elevate Your <br/>
            <span className="text-zinc-500">Regional Brand.</span>
          </h2>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 md:gap-10">
            ...
            <p className="text-technical text-[8px] md:text-[9px] text-zinc-500 uppercase tracking-widest text-left hidden sm:block border-l border-zinc-200 pl-8 leading-loose">

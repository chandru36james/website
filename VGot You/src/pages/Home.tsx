...
// ─── HELMET DATA (static — defined once outside component, never re-serialized) ──
const SCHEMA_ORGANIZATION = JSON.stringify({
  ...
  "logo": { "@type": "ImageObject", "url": "https://www.vgotyou.com/assets/vgotyou.png", "width": 512, "height": 512 },
  ...
  "foundingDate": "2022",
  "founder": { "@type": "Person", "name": "Chandru" },
  "address": { "@type": "PostalAddress", "addressLocality": "Karur", "addressRegion": "Tamil Nadu", "addressCountry": "IN" },
  "contactPoint": [
    { "@type": "ContactPoint", "telephone": "+917871120415", "contactType": "customer service", "areaServed": "IN", "availableLanguage": ["English", "Tamil"] },
    { "@type": "ContactPoint", "telephone": "+447351736645", "contactType": "customer service", "areaServed": "GB", "availableLanguage": "English" }
  ],
  "sameAs": ["https://www.linkedin.com/in/vgotyou/", "https://www.instagram.com/vgot_you/", "https://vgotyou.medium.com/", "https://vgotyou.sulekha.com", "https://clutch.co/profile/vgot-you", "https://www.goodfirms.co/company/vgot-you", "https://www.justdial.com/Karur/VGot-You-Andankoil/9999P4324-4324-260118183447-U7H4_BZDET?via=scode"]
});
...
const SCHEMA_LOCAL_BUSINESS = JSON.stringify({
  ...
  "geo": { "@type": "GeoCoordinates", "latitude": "10.9602", "longitude": "78.0766" },
  "areaServed": [{ "@type": "Country", "name": "India" }, { "@type": "Country", "name": "United Kingdom" }],
  "founder": { "@type": "Person", "name": "Chandru" },
  "aggregateRating": { "@type": "AggregateRating", "ratingValue": "4.9", "reviewCount": "18", "bestRating": "5", "worstRating": "1" },
...
const SCHEMA_WEBSITE = JSON.stringify({
  ...
  "potentialAction": { "@type": "SearchAction", "target": { "@type": "EntryPoint", "urlTemplate": "https://www.vgotyou.com/?s={search_term_string}" }, "query-input": "required name=search_term_string" }
});

const SCHEMA_SERVICES = JSON.stringify({
  "@context": "https://schema.org",
  "@type": "Service",
  ...
  "areaServed": [{ "@type": "Country", "name": "India" }, { "@type": "Country", "name": "United Kingdom" }],
  "serviceType": ["Web Design", "Website Development", "UI UX Design", "SEO Services", "Local SEO", "Branding", "Logo Design", "Digital Marketing", "E-commerce Website Design"],
  "offers": { "@type": "Offer", "priceSpecification": { "@type": "PriceSpecification", "priceCurrency": "INR", "description": "Custom pricing based on project scope" } }
});

const SCHEMA_BREADCRUMB = JSON.stringify({
  "@context": "https://schema.org",
  "@type": "BreadcrumbList",
  "itemListElement": [{ "@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.vgotyou.com/" }]
});
...
const SCHEMA_FAQ = JSON.stringify({
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "Are you a web design company in Karur?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, VGot You is a trusted web design company in Karur, Tamil Nadu, offering website design, website development, branding, and SEO services for local and global businesses." } },
    { "@type": "Question", "name": "Do you provide web design services across Tamil Nadu?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, VGot You provides professional web design and SEO services across Tamil Nadu including Chennai, Coimbatore, Madurai, Trichy, Salem, Tiruppur, Erode, Vellore, Thanjavur, Tirunelveli, and all major cities." } },
    { "@type": "Question", "name": "Do you offer SEO services in Tamil Nadu?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, we provide professional SEO and local SEO services in Karur and across Tamil Nadu to help businesses rank higher on Google and generate quality leads." } },
    { "@type": "Question", "name": "Do you build e-commerce websites?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, VGot You designs and develops SEO-friendly e-commerce websites for businesses across Tamil Nadu with secure payment integration and high-performance UI/UX." } },
    { "@type": "Question", "name": "Can you redesign an existing website?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, we offer website redesign services including modern UI/UX, speed optimization, mobile responsiveness, and SEO improvements for businesses in Karur and across Tamil Nadu." } },
    { "@type": "Question", "name": "Do you provide web design services in the UK?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, VGot You provides professional web design, branding, and SEO services for businesses across the UK including London, Manchester, Birmingham, Leeds, Glasgow, Liverpool, Bristol, Sheffield, Edinburgh, and more." } }
  ]
});

// ─── COUNT UP (starts only when element enters viewport) ──────────────────────
...
<div className="absolute inset-0 bg-black/60 z-10" />
    ...
    <div className="absolute inset-x-0 bottom-0 h-64 md:h-40 bg-linear-to-t from-black via-black/80 to-transparent z-10 pointer-events-none" />
    ...
    {/* Desktop & Tablet Vertical Social Bar */}
            <div className="hidden md:flex absolute right-4 lg:right-8 top-1/2 -translate-y-1/2 z-40 flex-col items-center gap-6">
                 ...
                 <div className="flex flex-col gap-6">
                    ...
                    <a href={"https://www.google.com/search?q=VGot+You+%E2%80%93+Web+Design+Company+in+karur&stick=H4sIAAAAAAAA_-NgU1I1qEhMMzVLMzNJtjS3NDY2MTK3MqhISjQ1TU6zMLGwME4xTjNKXsSqEeaeX6IQmV-q8KhhskJ4apKCS2pxZnqegnN-bkFiXqVCZp5CdmJRaREAmWh1LVQAAAA&hl=en&mat=CTYW_efeDqo4ElcBTVDHnjSrL1i_VTCa8_kuXYpK1iyu8maHPcIxMv-VA5S0wxGQN2FTkjTuTCQOIc3qOOv2BGOZtzpI4JPgrHCDZf5fjf6TpSzgZ-TLIOOTRC7snP24iCY&authuser=0"} 
                      target="_blank" rel="noopener noreferrer" aria-label="Google Business Profile" className="text-gray-400 hover:text-white transition-all hover:scale-110 duration-300">
...
const ServicesBento: React.FC = () => (
  <section className="py-16 md:py-32 bg-white text-black relative overflow-hidden">
    <div className="absolute top-0 left-1/4 w-125 h-125 bg-red-500/5 rounded-full blur-[120px] pointer-events-none" aria-hidden="true" />
    <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-blue-500/5 rounded-full blur-[120px] pointer-events-none" aria-hidden="true" />
    <div className="container mx-auto px-4 md:px-6 max-w-7xl relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-3 md:gap-6 auto-rows-min md:auto-rows-[350px]">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
          ...
          <div className="absolute right-0 top-0 w-3/5 h-full opacity-10 group-hover:opacity-30 transition-opacity duration-700 font-mono text-[8px] text-green-500 p-8 select-none leading-relaxed pointer-events-none overflow-hidden hidden sm:block" aria-hidden="true">
          ...
          <div className="relative z-10 h-full p-8 md:p-12 flex flex-col justify-between">
            <div className="w-14 h-14 bg-zinc-900 rounded-2xl flex items-center justify-center border border-zinc-800 group-hover:border-green-500/50 transition-all duration-500 mb-4">
              <svg className="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>
            </div>
            <div>
              ...
              <div className="flex flex-wrap gap-2.5 mt-5 relative z-30">
                {["React", "Next.js", "Tailwind", "Headless CMS"].map((tech) => (
                  <span
                    key={tech}
                    className="px-3.5 py-1 rounded-full bg-zinc-800/60 border border-zinc-700/60 text-[10px] md:text-xs text-zinc-300 font-medium tracking-wide backdrop-blur-sm transition-all duration-300 hover:bg-zinc-700/70 hover:border-zinc-500"
                  >
                    {tech}
                  </span>
                ))}
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }}
          ...
          <div className="relative z-10 h-full p-8 md:p-10 flex flex-col justify-between">
            <div className="w-14 h-14 bg-red-900/10 rounded-2xl flex items-center justify-center text-red-600 border border-red-900/20 group-hover:rotate-6 transition-all duration-500 mb-4">
              <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.5L15.232 5.232z" /></svg>
            </div>
            <div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }}
          ...
          <div className="absolute top-0 right-0 p-6 opacity-10 rotate-12 group-hover:rotate-0 group-hover:scale-125 transition-transform duration-700" aria-hidden="true">
          ...
          <div className="relative z-10 h-full p-8 md:p-10 flex flex-col justify-between">
            <div className="w-14 h-14 bg-white/20 backdrop-blur-xl rounded-2xl flex items-center justify-center text-white border border-white/30 shadow-2xl group-hover:-translate-y-1 transition-transform mb-4">
              <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17H3a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2h-2" /></svg>
            </div>
            <div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.3 }}
          className="md:col-span-4 bg-zinc-900 border border-zinc-800 rounded-4xl overflow-hidden shadow-xl min-h-[240px] relative group cursor-pointer hover:border-zinc-700 transition-all duration-500">
          <Link to="/digital-marketing" className="absolute inset-0 z-20" aria-label="Digital Marketing" />
          <div className="absolute inset-0 bg-linear-to-r from-zinc-900 via-zinc-900/95 to-transparent z-0" />
...
const AboutSection: React.FC = () => (
  <section className="container mx-auto py-24 md:py-32 px-6 md:px-12 bg-white relative overflow-hidden">
    <div className="absolute top-0 left-0 w-full h-full opacity-[0.03] pointer-events-none bg-[radial-gradient(#dc2626_1px,transparent_1px)] [background-size:24px_24px]" aria-hidden="true" />
          ...
          {ABOUT_FEATURES.map(({ icon, title, desc }, i) => (
            <div key={i} className="flex flex-col gap-4 p-6 rounded-3xl bg-zinc-50 border border-zinc-100 hover:bg-white hover:shadow-2xl hover:border-red-600/10 transition-all group">
              <div className="bg-white p-3 rounded-2xl shadow-sm text-red-600 w-fit group-hover:scale-110 transition-transform duration-500">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">{icon}</svg>
              </div>
              <div>
      ...
      <div className="hidden lg:flex relative h-[600px] w-full justify-end items-center">
        <div className="relative z-20 transform -translate-x-12 translate-y-12">
          <img
            ...
            loading="lazy"
            decoding="async"
            className="w-72 h-96 object-cover rounded-[2rem] shadow-2xl border-4 border-white hover:scale-[1.02] hover:-rotate-2 transition-all duration-700"
          />
        </div>
        <div className="relative z-10">
          <img
            ...
            loading="lazy"
            decoding="async"
            className="w-80 h-[500px] object-cover rounded-[2rem] shadow-2xl border-4 border-white hover:scale-[1.02] hover:rotate-2 transition-all duration-700 opacity-80 hover:opacity-100"
          />
        </div>
      </div>
    </div>
...
// ─── PROCESS STEP (memoized to prevent sibling re-renders on hover) ────────────
...
const ProcessStep = memo(({
  ...
  >
    ...
    <motion.div
      layout
      className={`z-20 flex items-center justify-center w-16 h-16 rounded-full shadow-lg border-2 mb-4 md:mb-0 flex-shrink-0 overflow-hidden p-3 transition-all duration-500 ${isHovered ? 'bg-red-600 border-red-600 scale-110' : 'bg-black border-red-600'}`}
      initial={{ scale: 0 }}
      whileInView={{ scale: 1 }}
      viewport={{ once: true }}
      transition={{ type: "spring", stiffness: 200, damping: 15, delay: index * 0.1 }}
    >
      <img src={step.icon} alt={step.title} width={40} height={40} loading="lazy" decoding="async" className="w-full h-full object-contain filter brightness-0 invert" />
    </motion.div>
    <motion.div layout className="w-full md:w-5/12">
      <motion.div layout className={`bg-zinc-900 border rounded-xl shadow-lg p-6 text-left relative overflow-hidden transition-all duration-300 ${isHovered ? 'border-red-900/50 shadow-2xl' : 'border-zinc-800'}`}>
          ...
          {isHovered && (
            ...
            >
              <div className="pt-4 border-t border-zinc-800 mt-4">
                <img src={step.image} alt={step.title} width={400} height={128} loading="lazy" decoding="async" className="w-full h-32 object-cover rounded-lg mb-4" />
...
const ProcessSection: React.FC = () => {
  ...
  return (
    <section className="relative py-20 px-4 bg-white overflow-hidden">
      ...
      />
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="relative z-10 container mx-auto text-center">
        <h2 className="text-4xl font-bold mb-16 text-red-600">Our Proven Process</h2>
      </motion.div>
      <div className="relative max-w-5xl mx-auto z-10">
        <div className="hidden md:block absolute top-0 left-1/2 w-0.5 h-full bg-zinc-800 -translate-x-1/2" aria-hidden="true" />
        {PROCESS_STEPS.map((step, index) => (
          <ProcessStep
            ...
            onMouseEnter={handlers[index].onMouseEnter}
            onMouseLeave={handlers[index].onMouseLeave}
          />
        ))}
      </div>
    </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        {TESTIMONIALS.map((t, i) => (
          <div key={i} className="bg-white border border-zinc-100 p-6 md:p-8 rounded-2xl flex flex-col h-full hover:shadow-xl hover:border-red-600/10 transition-all duration-500 group shadow-sm">
            <svg className="w-8 h-8 text-zinc-100 mb-4 group-hover:text-red-50 transition-colors" fill="currentColor" viewBox="0 0 18 14" aria-hidden="true">
            ...
            <div className="flex items-center gap-4 mt-auto pt-6 border-t border-zinc-50 group-hover:border-zinc-100 transition-colors">
              <div className="relative">
                <img
                  ...
                  loading="lazy"
                  decoding="async"
                  className="w-11 h-11 rounded-full object-cover ring-2 ring-zinc-50 group-hover:ring-red-100 transition-all duration-500"
                />
                <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-red-600 rounded-full flex items-center justify-center border-2 border-white" aria-hidden="true">
              ...
              <div>
                ...
                <div className="flex gap-0.5 mt-1.5" aria-label="5 star rating">
      ...
      <div className="mt-16 flex flex-col sm:flex-row items-center justify-center gap-10 md:gap-20 opacity-60 max-w-3xl mx-auto">
        {TRUST_STATS.map(({ val, label }, i) => (
          <React.Fragment key={i}>
            {i > 0 && <div className="hidden sm:block h-10 w-[1px] bg-zinc-100" aria-hidden="true" />}
    ...
    <div className="container mx-auto max-w-4xl text-center relative z-10">
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
        ...
        <p className="text-zinc-400 text-base md:text-lg mb-10 max-w-xl mx-auto leading-relaxed">
           Professional website, SEO-ready, mobile-first. 
        </p>

                  ...
                  <section className="py-24 md:py-32 px-6 bg-white border-b border-zinc-100">
                    <div className="container mx-auto max-w-7xl">
                      <div className="text-center mb-16">
                        <h2 className="text-[9px] sm:text-[10px] font-mono text-red-600 font-bold uppercase tracking-[0.4em] mb-4">Global Nodes</h2>
                        <h3 className="text-3xl sm:text-4xl md:text-6xl font-black uppercase tracking-tighter text-zinc-900">Countries We Serve</h3>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        ...
                        >
                          <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
                            <span className="text-8xl font-black">IN</span>
                          </div>
                          <div className="relative z-10">
                            <div className="w-12 h-12 rounded-2xl bg-white shadow-sm flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
                              <img src="https://flagcdn.com/in.svg" alt="India Flag" className="w-8 h-auto rounded-sm" />
                            </div>
                            <h4 className="text-2xl font-black text-zinc-900 mb-2 tracking-tighter uppercase">India</h4>
                            <p className="text-zinc-500 text-sm leading-relaxed mb-6">Strategic web design and SEO solutions for businesses across India.</p>
                        ...
                        >
                          <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
                            <span className="text-8xl font-black">UK</span>
                          </div>
                          <div className="relative z-10">
                            <div className="w-12 h-12 rounded-2xl bg-white shadow-sm flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
                              <img src="https://flagcdn.com/gb.svg" alt="UK Flag" className="w-8 h-auto rounded-sm" />
                            </div>
                            <h4 className="text-2xl font-black text-zinc-900 mb-2 tracking-tighter uppercase">United Kingdom</h4>
                            <p className="text-zinc-500 text-sm leading-relaxed mb-6">Premium digital experiences and branding for the UK market.</p>
                            <div className="flex items-center gap-2 text-[10px] font-black tracking-widest uppercase text-red-600 group-hover:gap-4 transition-all">
                              Explore Region
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
                            </div>

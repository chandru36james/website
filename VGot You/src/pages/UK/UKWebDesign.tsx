...
const FAQItem: React.FC<{ faq: { q: string, a: string }, isOpen: boolean, toggle: () => void }> = ({ faq, isOpen, toggle }) => (
    <div className="border-b border-zinc-100 dark:border-zinc-900 overflow-hidden">
        <button 
            onClick={toggle}
            className="w-full py-6 flex items-center justify-between text-left group transition-colors"
        >
            <h4 className={`text-sm sm:text-base font-bold uppercase tracking-widest transition-colors ${isOpen ? 'text-red-600' : 'text-zinc-900 dark:text-white group-hover:text-red-500'}`}>
                {faq.q}
            </h4>
            <div className={`flex-shrink-0 ml-4 transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}>
                {isOpen ? (
                    ...
                    <PlusIcon className="w-5 h-5 text-zinc-400 dark:text-zinc-600 group-hover:text-red-500" />
                )}
            </div>
        </button>
...
const UKWebDesign: React.FC = () => {
    ...
    const faqs = [
        {
            ...
            a: "Web design costs in the UK are bespoke and depend on your project's features, complexity, and specific integrations. We provide tailored, fixed-price quotes based on your specific requirements."
        },
        {
  ...
  <meta
    name="description"
    content="VGot You offers premium web design services across the UK — fast, SEO-optimised, conversion-focused websites for businesses in London, Manchester, Birmingham, Leeds, Glasgow and more."
  />
  ...
  */}
  <script type="application/ld+json">{`
    {
      ...
      "hasOfferCatalog": {
        ...
        "itemListElement": [
          {
            "@type": "Offer",
            "name": "Startup Web Design Plan UK",
            "itemOffered": {
              "@type": "Service",
          ...
          {
            "@type": "Offer",
            "name": "Business Web Design Plan UK",
            "itemOffered": {
              "@type": "Service",
          ...
          {
            "@type": "Offer",
            "name": "Enterprise Web Design Plan UK",
            "itemOffered": {
              "@type": "Service",
      ...
      "offers": {
        "@type": "Offer",
        "description": "Premium, bespoke web design solutions for UK businesses with customized quotes based on custom scope"
      }
    }
  `}</script>
  ...
  {/*
    ...
    The pricing FAQ and timeline FAQ are especially
  ...
  */}
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Web design costs in the UK are bespoke and depend on your project's features, complexity, and specific integrations. We provide tailored, fixed-price quotes based on your specific requirements."
          }
        },
        {
          "@type": "Question",
  ...
  `}</script>
            ...
            <section className="relative px-4 sm:px-6 pt-24 pb-6 md:pt-32 md:pb-24 overflow-hidden bg-cover bg-center bg-white dark:bg-black" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1600&q=80')" }}>
                ...
                <div className="container mx-auto max-w-6xl relative z-10 py-1 md:py-2">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        >
                            Strategic
                            <span className="block text-red-500">Web Design UK.</span>
                        </m.h1>
                        ...
                        >
                            <m.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="w-[170px] sm:w-[195px]">
                                <Link
                                    to="/contact?message=I'm interested in a Free Consultation for my UK business."
            ...
            {/* Trust & Authority */}
            <section className="py-12 md:py-16 border-b border-zinc-100 dark:border-zinc-900 bg-zinc-50 dark:bg-[#050505]/40 transition-colors duration-300">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={i} className="text-center">
                                <div className="text-4xl md:text-5xl font-black text-zinc-900 dark:text-white mb-2 tracking-tighter">{stat.value}</div>
            ...
            {/* Services Section */}
            <section className="py-16 md:py-20 px-4 sm:px-6 border-b border-zinc-100 dark:border-zinc-900 bg-white dark:bg-transparent transition-colors duration-300">
                <div className="container mx-auto max-w-7xl">
                    <TechnicalHeader label="Core Offerings" code="UK_SERVICE_MODULE" />
                    <div className="text-center mb-20">
                        <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-6 text-zinc-900 dark:text-white">Expert Web Solutions</h2>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {services.map((service, i) => (
                            <div key={i} className="p-8 bg-zinc-50 dark:bg-[#080808] border border-zinc-100 dark:border-zinc-900 rounded-[10px] hover:border-red-600/30 transition-all group">
                                <div className="w-12 h-12 bg-white dark:bg-zinc-900 rounded-[10px] flex items-center justify-center mb-8 text-red-600 group-hover:scale-110 transition-transform shadow-sm dark:shadow-none">
                                    {service.icon}
                                </div>
                                <h3 className="text-xl font-bold mb-4 uppercase tracking-tight text-zinc-900 dark:text-white">{service.title}</h3>
            ...
            {/* Why Choose Us */}
            <section className="py-16 md:py-20 px-4 sm:px-6 bg-zinc-50 dark:bg-[#050505]/60 border-b border-zinc-100 dark:border-zinc-900 transition-colors duration-300">
                <div className="container mx-auto max-w-7xl">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <div>
                            <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-8 text-zinc-900 dark:text-white">Why Choose <br/><span className="text-red-600">VGot You UK?</span></h2>
                            <div className="space-y-8">
                                {[
                                    ...
                                    <div key={i} className="flex gap-6">
                                        ...
                                        <div>
                                            <h4 className="text-zinc-900 dark:text-white font-bold uppercase tracking-widest mb-2">{item.t}</h4>
                        ...
                        <div className="relative">
                            <div className="aspect-square bg-zinc-200 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[10px] overflow-hidden relative group">
                                <img src="https://picsum.photos/seed/ukweb/800/800" alt="Professional web design services for UK businesses – VGot You" className="w-full h-full object-cover opacity-100 transition-all duration-700" referrerPolicy="no-referrer" />
                                <div className="absolute bottom-10 left-10 bg-black/40 backdrop-blur-md border border-white/10 p-5 rounded-[10px] shadow-xl">
                                    <div className="text-4xl font-black text-white mb-1.5 leading-none">UK-WIDE</div>
                                    <div className="text-[10px] font-mono text-red-400 uppercase tracking-[0.3em]">Digital Authority</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-5 gap-8">
                        {[
                            ...
                            <div key={i} className="relative">
                                <div className="text-6xl font-black text-zinc-100 dark:text-zinc-900 mb-6">{item.step}</div>
                                <h4 className="text-zinc-900 dark:text-white font-bold uppercase tracking-widest mb-4">{item.title}</h4>
                                <p className="text-zinc-500 text-xs leading-relaxed">{item.desc}</p>
                                {i < 4 && <div className="hidden md:block absolute top-8 -right-4 w-8 h-[1px] bg-zinc-200 dark:bg-zinc-800"></div>}
                            </div>
                        ))}
                    </div>
                </div>
            ...
            {/* Design & Scope Packages */}
            <section className="py-16 md:py-20 px-4 sm:px-6 bg-zinc-50 dark:bg-[#050505]/60 border-b border-zinc-100 dark:border-zinc-900 transition-colors duration-300">
                <div className="container mx-auto max-w-7xl">
                    <TechnicalHeader label="Investment Blueprint" code="UK_DESIGN_MODELS" />
                    <div className="text-center mb-20">
                        <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-6 text-zinc-900 dark:text-white">Design Packages</h2>
                        <p className="text-zinc-500 max-w-2xl mx-auto">Premium web design solutions tailored specifically to your UK business model.</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className={`p-10 border ${pkg.popular ? 'border-red-600 bg-red-600/5' : 'border-zinc-200 dark:border-zinc-900 bg-white dark:bg-black'} rounded-[10px] relative group transition-all`}>
                                {pkg.popular && <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 bg-red-600 text-[10px] font-bold uppercase tracking-widest text-white">Most Popular</div>}
                                <h3 className="text-2xl font-black uppercase tracking-tighter mb-2 text-zinc-900 dark:text-white">{pkg.name}</h3>
                                <div className="text-4xl font-black text-red-600 dark:text-white mb-8">{pkg.price}</div>
                                <ul className="space-y-4 mb-10">
                                    {pkg.features.map((f, j) => (
                                        <li key={j} className="flex items-center gap-3 text-sm text-zinc-500">
                                            <CheckCircleIcon className="w-4 h-4 text-red-600" />
                                            {f}
                                        </li>
                                    ))}
                                </ul>
                                <Link to={`/contact?message=Hi VGot You, I'm interested in the ${pkg.name} options for my UK business. Please provide more information.`} className={`block w-full py-4 text-center font-bold uppercase tracking-widest text-xs transition-all ${pkg.popular ? 'bg-red-600 text-white hover:bg-red-700' : 'border border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-white hover:bg-zinc-900 hover:text-white dark:hover:bg-white dark:hover:text-black'}`}>
                                    Initialize Design
                                </Link>
                            </div>
                        ))}
            ...
            <section className="py-16 md:py-20 px-4 sm:px-6 border-b border-zinc-100 dark:border-zinc-900 bg-white dark:bg-transparent transition-colors duration-300">
                <div className="container mx-auto max-w-7xl text-center">
                    ...
                    <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-16 text-zinc-900 dark:text-white">Our Technology</h2>
                    <div className="flex flex-wrap justify-center gap-4">
                        {["React", "Next.js", "TypeScript", "Tailwind CSS", "Node.js", "Shopify", "Figma"].map((tech, i) => (
                            <div key={i} className="px-8 py-4 bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-900 rounded-[10px] font-mono text-xs uppercase tracking-widest text-zinc-500 hover:text-red-600 hover:border-red-600/30 transition-all">
                                {tech}
                            </div>
                        ))}
                    </div>
            ...
            {/* Portfolio Section */}
            <section className="py-16 md:py-20 bg-zinc-50 dark:bg-[#050505]/60 border-b border-zinc-100 dark:border-zinc-900 transition-colors duration-300">
                <div className="container mx-auto px-6 max-w-7xl text-center">
                    <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-8 text-zinc-900 dark:text-white">Our UK Portfolio</h2>
                    ...
                    <Link to="/portfolio" className="inline-flex items-center gap-4 px-10 py-5 bg-zinc-900 dark:bg-white text-white dark:text-black font-bold rounded-[10px] uppercase tracking-[0.2em] hover:bg-red-600 hover:text-white transition-all shadow-xl">
            ...
            <section className="py-16 md:py-20 px-4 sm:px-6 border-b border-zinc-100 dark:border-zinc-900 bg-white dark:bg-transparent transition-colors duration-300">
                <div className="container mx-auto max-w-7xl">
                    <div className="text-center mb-20">
                        <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-6 text-zinc-900 dark:text-white">Client Feedback</h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {[
                            ...
                            <div key={i} className="p-10 bg-zinc-50 dark:bg-[#080808] border border-zinc-100 dark:border-zinc-900 rounded-[10px]">
                                <div className="flex gap-1 mb-6">
                                    {[...Array(5)].map((_, i) => <StarIcon key={i} className="w-4 h-4 text-red-600" />)}
                                </div>
                                <p className="text-zinc-500 italic mb-8">"{t.text}"</p>
                                <div>
                                    <div className="text-zinc-900 dark:text-white font-bold uppercase tracking-widest text-sm">{t.name}</div>
                                    <div className="text-zinc-500 text-[10px] uppercase tracking-widest mt-1">{t.role}</div>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="py-16 md:py-20 bg-zinc-50 dark:bg-[#050505]/60 border-b border-zinc-100 dark:border-zinc-900 transition-colors duration-300">
                <div className="container mx-auto px-6 max-w-7xl">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-8 text-zinc-900 dark:text-white">Serving the UK Market</h2>
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            {["London", "Manchester", "Birmingham", "Leeds", "Glasgow", "Liverpool", "Bristol", "Sheffield", "Edinburgh", "Leicester", "Cardiff", "Belfast"].map(city => (
                                <Link key={city} to={`/web-design-${city.toLowerCase()}`} className="px-6 py-3 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[10px] text-xs font-bold uppercase tracking-widest text-zinc-900 dark:text-white hover:border-red-600 transition-all shadow-sm">
                                     {city}
                                </Link>
                            ))}
                        </div>
            ...
            <section className="py-16 md:py-20 px-4 sm:px-6 border-b border-zinc-100 dark:border-zinc-900 bg-white dark:bg-transparent transition-colors duration-300">
                <div className="container mx-auto max-w-3xl">
                    <h2 className="text-4xl font-black uppercase tracking-tighter mb-16 text-center text-zinc-900 dark:text-white">Frequently Asked Questions</h2>
            ...
            {/* Final CTA */}
            <section className="py-16 md:py-24 px-4 sm:px-6 text-center bg-zinc-50 dark:bg-[#080808] border-b border-zinc-100 dark:border-zinc-900 relative transition-colors duration-300">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(220,38,38,0.05)_0%,transparent_70%)]"></div>
                <div className="max-w-4xl mx-auto relative z-10">
                    <h2 className="text-5xl sm:text-7xl md:text-[8vw] font-black uppercase leading-[0.8] mb-8 md:mb-12 tracking-tighter text-zinc-900 dark:text-white">
                        Ready to <br/>
                    ...
                    <Link to="/contact?message=I'm ready to connect and discuss my UK web design project." className="w-[180px] sm:w-[195px] inline-flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white font-bold px-4 py-2.5 rounded-[10px] transition-all duration-300 text-[11px] sm:text-xs uppercase tracking-wider shadow-lg shadow-red-600/20">
                        Get Touch
                    </Link>
                </div>
            </section>

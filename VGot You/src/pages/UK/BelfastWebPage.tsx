...
const BelfastWebPage: React.FC = () => {
    return (
        <div className="bg-[#020202] text-white selection:bg-red-600/30 overflow-x-hidden pt-20">
            <Helmet>
              <title>Web Design Belfast | Website Design Experts</title>
              <meta name="description" content="Top web design services in Belfast. Custom websites designed for performance and conversions." />
              ...
              <script type="application/ld+json">
                {JSON.stringify({
                  ...
                  "itemListElement": [
                    ...
                    { "@type": "ListItem", "position": 2, "name": "Web Design UK", "item": "https://www.vgotyou.com/web-design-uk" },
                    { "@type": "ListItem", "position": 3, "name": "Web Design Belfast", "item": "https://www.vgotyou.com/web-design-Belfast" }
                  ]
                })}
              </script>
            </Helmet>

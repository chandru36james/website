  ...
  <script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.vgotyou.com/"},{"@type":"ListItem","position":2,"name":"Web Design UK","item":"https://www.vgotyou.com/web-design-uk"},{"@type":"ListItem","position":3,"name":"Web Design Glasgow","item":"https://www.vgotyou.com/web-design-glasgow"}]}`}</script>
                ...
                <div className="relative z-10 px-6 max-w-7xl mx-auto text-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                            <Link to="/contact?message=Hi VGot You, I'm interested in a web design quote for my Glasgow-based business." className="px-10 py-5 bg-red-600 text-white font-bold rounded-sm uppercase tracking-[0.2em] hover:bg-red-700 transition-all shadow-[0_0_30px_rgba(220,38,38,0.2)]">
                                Request Quote
                            </Link>
            ...
            <section className="py-24 px-6 text-center bg-black relative">
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    ...
                    <Link to="/contact?message=Hi VGot You, I'm ready to start my Glasgow web design project. Let's get started!" className="px-12 py-5 bg-red-600 text-white font-bold rounded-sm uppercase tracking-[0.3em] shadow-[0_0_50px_rgba(220,38,38,0.3)] hover:bg-red-700 transition-all inline-block">
                        Get Started
                    </Link>
                </div>
            </section>

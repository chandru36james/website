...
const SheffieldWebPage: React.FC = () => {
    ...
    return (
        <div className="bg-white dark:bg-[#020202] text-zinc-900 dark:text-white selection:bg-red-600/30 overflow-x-hidden transition-colors duration-300">
            ...
            <Helmet>
  <html lang="en-GB" />
  <title>Web Design Company in Sheffield | Affordable Websites | VGot You</title>
  <meta name="description" content="VGot You delivers professional web design for Sheffield businesses — from steel industry firms to creative digital studios. SEO-optimised websites as bespoke solutions." />
  <meta name="author" content="VGot You" />
  <meta name="robots" content="index, follow" />
  <link rel="canonical" href="https://www.vgotyou.com/web-design-sheffield" />
  <link rel="alternate" hrefLang="en-GB" href="https://www.vgotyou.com/web-design-sheffield" />
  ...
  <meta property="og:title" content="Web Design Company in Sheffield | Affordable Websites | VGot You" />
  <meta property="og:description" content="Professional web design for Sheffield businesses — from steel industry firms to creative digital studios. SEO-optimised websites as bespoke solutions." />
  <meta property="og:url" content="https://www.vgotyou.com/web-design-sheffield" />
  <meta property="og:image" content="https://www.vgotyou.com/assets/vgotyou.png" />
  <meta property="og:image:width" content="1200" />
  <meta property="og:image:height" content="630" />
  <meta property="og:image:alt" content="Web Design Services in Sheffield – VGot You" />
  <meta property="og:locale" content="en_GB" />
  <meta property="og:locale:alternate" content="en_IN" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Web Design Company in Sheffield | Affordable Websites | VGot You" />
  <meta name="twitter:description" content="Professional web design for Sheffield businesses. SEO-optimised websites as bespoke solutions." />
  ...
  <script type="application/ld+json">{`{"@context":"https://schema.org","@type":"WebPage","@id":"https://www.vgotyou.com/web-design-sheffield#webpage","url":"https://www.vgotyou.com/web-design-sheffield","name":"Web Design Company in Sheffield | Affordable Websites | VGot You","description":"Professional web design for Sheffield businesses — from steel industry firms to creative digital studios. SEO-optimised websites as bespoke solutions.","inLanguage":"en-GB","isPartOf":{"@id":"https://www.vgotyou.com/#website"},"publisher":{"@id":"https://www.vgotyou.com/#organization"},"about":{"@id":"https://www.vgotyou.com/web-design-sheffield#service"}}`}</script>
  <script type="application/ld+json">{`{"@context":"https://schema.org","@type":"Service","@id":"https://www.vgotyou.com/web-design-sheffield#service","name":"Web Design Services in Sheffield","url":"https://www.vgotyou.com/web-design-sheffield","description":"Professional web design for Sheffield businesses — custom websites, e-commerce and SEO-optimised development across South Yorkshire.","serviceType":["Web Design Sheffield","Custom Website Design","E-commerce Website Development Sheffield","SEO-Optimised Web Design","Mobile-First Website Design","Small Business Website Design Sheffield"],"provider":{"@id":"https://www.vgotyou.com/#organization"},"areaServed":[{"@type":"City","name":"Sheffield"},{"@type":"Country","name":"United Kingdom"}],"offers":{"@type":"Offer","description":"Premium, bespoke web design solutions on request"}}}`}</script>
  <script type="application/ld+json">{`{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Do you provide web design services in Sheffield?","acceptedAnswer":{"@type":"Answer","text":"Yes, VGot You provides professional web design for businesses across Sheffield including the city centre, Kelham Island and across South Yorkshire."}},{"@type":"Question","name":"How much does web design cost in Sheffield?","acceptedAnswer":{"@type":"Answer","text":"Our Sheffield web design packages start as bespoke solutions. Transparent, fixed-price quotes — no hidden fees."}},{"@type":"Question","name":"Do you build websites for Sheffield manufacturing companies?","acceptedAnswer":{"@type":"Answer","text":"Yes, we build professional B2B websites for Sheffield manufacturers — helping you showcase products and capabilities to national and global clients."}},{"@type":"Question","name":"How long does web design take for a Sheffield business?","acceptedAnswer":{"@type":"Answer","text":"Most projects are completed in 4-8 weeks. We always provide a clear timeline upfront."}}]}`}</script>
  <script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.vgotyou.com/"},{"@type":"ListItem","position":2,"name":"Web Design UK","item":"https://www.vgotyou.com/web-design-uk"},{"@type":"ListItem","position":3,"name":"Web Design Sheffield","item":"https://www.vgotyou.com/web-design-sheffield"}]}`}</script>
</Helmet>
                ...
                <div className="container mx-auto max-w-6xl relative z-10 py-1 md:py-2">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        >
                            Web Design
                            <br />
                            <span className="text-red-500">Sheffield.</span>
                        </m.h1>
                        ...
                        >
                            <m.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="w-[170px] sm:w-[195px]">
                                <Link
                                    to="/contact?message=Hi VGot You, I'm interested in a web design quote for my Sheffield-based business."
                        ...
                        >
                            ...
                            {[
                                ...
                                const isActive = item.name === "Sheffield";
                                return (
                                    <Link
                                        key={item.name}
                                        to={item.path}
                ...
                <div className="container mx-auto max-w-7xl">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <div>
                            ...
                            <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter mb-8 text-zinc-900 dark:text-white">Helping Sheffield Businesses <span className="text-red-600">Scale.</span></h2>
                            <p className="text-zinc-500 dark:text-zinc-400 text-lg leading-relaxed mb-8">
                                As a specialized <strong className="text-zinc-900 dark:text-white">web design agency in Sheffield</strong>, we help local manufacturers and tech firms forge a strong online presence that drives growth.
                            </p>
                            <div className="grid grid-cols-2 gap-8">
                                ...
                                <div>
                                    <div className="text-3xl font-black text-zinc-900 dark:text-white mb-1">3.5s</div>
                        ...
                        <div className="bg-zinc-100 dark:bg-zinc-900 aspect-video rounded-[10px] border border-zinc-200 dark:border-zinc-800 overflow-hidden relative group transition-all duration-500">
                            <img src="https://picsum.photos/seed/sheffield/800/450" alt="Sheffield Web Design" className="w-full h-full object-cover opacity-100 group-hover:scale-105 transition-all duration-500" referrerPolicy="no-referrer" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 md:py-20 px-6 text-center bg-zinc-50 dark:bg-[#080808] border-b border-zinc-100 dark:border-zinc-900 relative transition-colors duration-300">
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    ...
                    <Link to="/contact?message=Hi VGot You, I'm ready to start my Sheffield web design project. Let's get started!" className="px-12 py-5 bg-red-600 text-white font-bold rounded-[10px] uppercase tracking-[0.3em] shadow-[0_0_50px_rgba(220,38,38,0.3)] hover:bg-red-700 transition-all inline-block">
                        Get Started
                    </Link>
                </div>
            </section>

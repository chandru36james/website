                ...
                <div className="relative z-10 px-6 max-w-7xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-sm sm:text-lg md:text-xl text-zinc-400 max-w-3xl mx-auto font-light leading-relaxed mb-8 md:mb-12">
                            The digital heartbeat of the UK. We help London-based startups and established enterprises dominate the global stage with cutting-edge web architecture.
                        </p>
            ...
            <section className="py-24 px-6 border-b border-zinc-900">
                <div className="container mx-auto max-w-7xl">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <div>
                            <TechnicalHeader label="Capital Authority" code="VGY_LONDON_NODE_01" />
                            <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter mb-8">Helping London Businesses <span className="text-red-600">Scale.</span></h2>
                            <p className="text-zinc-400 text-lg leading-relaxed mb-8">
                                As a specialized <strong className="text-white">web design agency in London</strong>, we understand the fast-paced nature of the capital's market. We provide the technical expertise to elevate your brand above the noise.
                            </p>
                            <div className="grid grid-cols-2 gap-8">
                                <div>
                                    <div className="text-3xl font-black text-white mb-1">50+</div>
                                    <div className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest">London Clients</div>
                                </div>
                                <div>
                                    <div className="text-3xl font-black text-white mb-1">24/7</div>
                                    <div className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest">Global Support</div>
                                </div>
                            </div>
                        </div>
                        <div className="bg-zinc-900 aspect-video rounded-sm border border-zinc-800 overflow-hidden relative grayscale group hover:grayscale-0 transition-all duration-700">
                            <img src="https://picsum.photos/seed/london/800/450" alt="London Web Design" className="w-full h-full object-cover opacity-50 group-hover:opacity-100 transition-opacity" referrerPolicy="no-referrer" />

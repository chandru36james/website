          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
            <div className="order-2 lg:order-1">
              <div className="relative aspect-video border border-zinc-900 bg-zinc-950 p-3 md:p-4 rounded-sm group overflow-hidden shadow-[0_0_40px_rgba(0,0,0,0.5)]">
                ...
                <img src="/assets/digital-marketing.png" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000 opacity-40 group-hover:opacity-90" alt="Digital marketing strategy and performance analytics – VGot You" />

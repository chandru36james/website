...
const AboutMe: React.FC = () => {
    ...
    return (
        <div className="relative min-h-screen bg-brand-white flex flex-col items-center justify-center text-center px-6 pt-24 pb-12 overflow-hidden">
            <ParticleBackground />
            <Helmet>
  <title>About Me | VGOT YOU - Creative Web & Logo Designer</title>
  <meta 
    name="description" 
  ...
  />
  <link rel="canonical" href="https://www.vgotyou.com/aboutme" />
  ...
  <script type="application/ld+json">
    {`
    {
      ...
      "image": "https://www.vgotyou.com/assets/profile.jpg"
    }
    `}
  </script>
</Helmet>

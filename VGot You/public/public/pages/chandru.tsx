...
const AboutMe: React.FC = () => {
    ...
    const skillSets = [
        ...
        },
        {
            ...
            description: "Driving growth through data & identity.",
    ...
    return (
        ...
        <div className="relative w-full min-h-screen bg-white dark:bg-black overflow-hidden transition-colors duration-300">
            <Helmet>
        {/* Basic SEO */}
        <title>Chandru | Web Designer & Creative Developer at VGot You</title>
        <meta
          name="description"
          content="Chandru is a professional web designer and creative developer at VGot You, specializing in modern websites, UI/UX, branding, and SEO-friendly digital experiences."
        />
        <meta
          name="keywords"
          content="Chandru web designer, Chandru VGot You, web designer Karur, UI UX designer Tamil Nadu, freelance web designer India, branding expert Karur"
        />
        ...
        <meta property="og:title" content="Chandru | Web Designer at VGot You" />
        <meta
          property="og:description"
          content="Meet Chandru, the creative mind behind VGot You. Expert in web design, branding, UI/UX, and SEO."
        />
        <meta
          property="og:image"
          content="https://www.vgotyou.com/assets/chandru.png"
        />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Chandru | Web Designer at VGot You" />
        <meta
          name="twitter:description"
          content="Professional web designer and creative developer at VGot You."
        />
        <meta
          name="twitter:image"
          content="https://www.vgotyou.com/assets/chandru.png"
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            alumniOf: {
              ...
              name: "VSB College of Engineering, Karur",
            },
            address: {
              "@type": "PostalAddress",
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            potentialAction: {
              "@type": "SearchAction",
              target:
                "https://www.vgotyou.com/search?q={search_term_string}",
                ...
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24 mb-24 lg:mb-32">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-8 max-w-2xl mx-auto lg:mx-0 font-light">
                            I'm the multidisciplinary developer and brand strategist behind VGot You. My mission is to strip away the unnecessary to reveal the essence of a brand, creating digital experiences that are as functional as they are beautiful.
                        </p>
                ...
                >
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto">
                        ...
                        <p className="text-gray-400 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
                            I believe great design is invisible. It works so well you don't even notice it. My approach strips away the noise to focus on what truly matters: your message, your brand, and your users.
                        </p>
                    </div>
                </motion.div>

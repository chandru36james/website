...
const SaranrajProfile: React.FC = () => {
  ...
  <meta
    name="keywords"
    content="Saranraj V, VGot You co founder, AI engineer India, machine learning engineer, data scientist VGot You, artificial intelligence developer, predictive models expert"
  />

  <meta name="author" content="Saranraj V | VGot You" />
  ...
  <meta property="og:title" content="Saranraj V | Co-Founder of VGot You" />
  <meta
    property="og:description"
    content="Meet Saranraj V, Co-Founder of VGot You and specialist in Artificial Intelligence, Machine Learning, and Data Science."
  />
  <meta property="og:image" content="https://www.vgotyou.com/assets/saran.png" />

  {/* ================= TWITTER ================= */}
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Saranraj V | AI & Data Science Specialist" />
  <meta
                ...
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24 mb-24 lg:mb-32">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                            <Link to="/contact" className="px-8 py-4 bg-zinc-900 text-white font-bold rounded-full hover:scale-105 transition-transform shadow-lg hover:bg-red-600">
                                Get In Touch
                            </Link>

...
const Contact: React.FC = () => {
  ...
  <meta
    name="description"
    content="Get in touch with VGot You for creative logo design and web design services. Let’s build your brand’s digital presence together."
  />
  ...
  <meta property="og:title" content="Contact VGot You | Hire a Web & Logo Designer" />
  <meta property="og:description" content="Let’s collaborate! Reach out to VGot You for custom logo design and web design services that elevate your brand." />
  <meta property="og:url" content="https://www.vgotyou.com/contact" />
  <meta property="og:site_name" content="VGot You" />
  <meta property="og:image" content="https://www.vgotyou.com/images/contact-preview.jpg" />
  <meta property="og:locale" content="en_US" />

  {/* Twitter Card */}
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Contact VGot You | Hire a Web & Logo Designer" />
  <meta name="twitter:description" content="Connect with VGot You for expert logo & web design. Let’s build your digital presence." />
  <meta name="twitter:image" content="https://www.vgotyou.com/images/contact-preview.jpg" />
  ...
  {/* Structured Data (JSON-LD for Local Business / Contact Page) */}
  <script type="application/ld+json">{`
  {
    ...
    "name": "VGot You",
    "description": "Creative logo design and web design services.",
    "publisher": {
      "@type": "Organization",
      "name": "VGot You",
      "logo": {
  ...
  `}</script>
            ...
            {/* Hero Section */}
            <section className="h-[40vh] w-full relative flex items-center justify-center text-center text-white bg-cover bg-center" style={{ backgroundImage: `url(${"https://vgotyou.com/assets/contact-banner.png"})` }}>

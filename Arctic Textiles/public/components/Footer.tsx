    ...
    return (
        <footer className="bg-zinc-900 text-white py-12 border-t border-zinc-800">
            <div className="container mx-auto px-6 text-center">
                <h3 className="text-3xl font-bold mb-4 font-cambria">VGot You</h3>
                <p className="text-gray-400 max-w-md mx-auto mb-8">
                    Crafting digital experiences that are not only beautiful but also functional. Let's build something amazing together.
                </p>
                ...
                <p className="text-gray-500 text-sm">&copy; {new Date().getFullYear()} <span className="font-cambria">VGot You</span>. All Rights Reserved.</p>
            </div>
        </footer>
    );
};
